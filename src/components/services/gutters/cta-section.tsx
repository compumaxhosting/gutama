...
export function GuttersCtaSection() {
  const content = {
        ...
        accent: "Today",
        description: "Don't wait for the next storm. Contact our Essex County specialists now for a free estimate on your gutter installation or replacement project.",
