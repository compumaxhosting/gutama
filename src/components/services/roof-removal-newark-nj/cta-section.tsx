...
export function RoofRemovalCtaSection() {
  const content = {
    image: "/images/roof-removal2.webp",
    imageAlt: "Roof Removal Newark NJ",

    title: "Get a Free",
    accent: "Roof Replacement Estimate",

    description:
      "Looking for the Best Roofing Company in Newark NJ? Contact Gutama Roofing today for professional Roof Removal Newark NJ, expert roof tear-off services, and affordable roof replacement solutions.",
