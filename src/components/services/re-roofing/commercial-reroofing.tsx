export function CommercialReRoofingSection() {
  const properties = [
    "Office buildings",
    "Retail centers",
    "Warehouses",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-5xl">
          ...
          <p className="text-base leading-loose text-muted-foreground">
            We provide professional re-roofing solutions for commercial
            properties throughout Essex County.
          </p>
        </div>
        ...
        <div className="mt-12 border border-border bg-card p-8 md:p-10 lg:p-12">
          ...
          <p className="mt-10 border-t border-border pt-8 text-base leading-loose text-muted-foreground">
            Our team works efficiently to minimize disruptions while
            maintaining the highest quality standards throughout every phase of
            the project.
          </p>
        </div>
      </div>
