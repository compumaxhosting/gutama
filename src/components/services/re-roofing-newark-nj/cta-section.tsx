...
export function ReRoofingCtaSection() {
  const content = {
    image: "/images/re-roofing2.webp",
    imageAlt: "Re-Roofing Services Newark NJ",

    title: "Get a Free",
    accent: "Re-Roofing Estimate",

    description:
      "If your roof is showing signs of wear, storm damage, or age-related deterioration, Gutama Roofing NJ can help. We provide professional roof inspections, honest recommendations, and high-quality re-roofing solutions for homeowners and businesses throughout Newark and Essex County.",
