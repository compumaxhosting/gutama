...
export function SidingCtaSection() {
  const content = {
        ...
        description: "Ready to transform your home's exterior? Call 973-820-5130 today for a free estimate from the top-rated siding contractors near me in Essex County.",
