...
export function FlatRoofCtaSection() {
  const content = {
  image: "/images/after-flat.webp",
  imageAlt: "Flat roofing services in Newark NJ",

  title: "Get a Free Flat Roofing",
  accent: "Estimate",

  description:
    "Whether you need flat roof repair, flat roof replacement, commercial flat roofing, or a new flat roof installation, Gutama Roofing NJ has the experience and expertise to deliver reliable results. Contact Gutama Roofing NJ today for a free flat roofing estimate in Newark, NJ and throughout Essex County.",

  buttonLabel: "Request Free Estimate",
};
  ...
  return (
    <section className="relative overflow-hidden py-8 px-6">
      ...
      <div className="relative z-10 mx-auto max-w-2xl text-center">
        ...
        <p className="mx-auto mb-14 max-w-2xl text-base leading-loose text-muted-foreground">{content.description}</p>
