...
export function CarpentryCtaSection() {
  const content = {
        ...
        accent: "With Expert Carpentry",
        description: "Enhance your home today. Call 973-820-5130 now for a free estimate from the top-rated carpentry services near me in Essex County.",
