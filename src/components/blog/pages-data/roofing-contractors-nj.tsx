...
export const roofingContractorsNj = {
  title:
    "Top Roofing Services in Essex County, NJ: Affordable & Reliable Contractors Near You",
      ...
      content: (
        <>
          ...
          <p>
            ...
            of Essex County, NJ — from urban neighborhoods in East Orange and
            Irvington to suburban communities in Millburn, Bloomfield, and Cedar
            Grove. They offer roof repair, full roof replacement, siding
            installation, and complete exterior services at competitive,
            transparent pricing.
          </p>
          <p>
  ...
  sections: [
    {
      ...
      content: (
        <>
          ...
          <p className="font-semibold mt-4">
            Key advantages of hiring a local roofer:
          </p>
          <ul>
            <li>Familiarity with NJ permits and inspections</li>
            <li>Faster emergency response</li>
            <li>Better material selection for winters</li>
            <li>Local reputation and references</li>
            <li>Knowledge of local architecture</li>
          </ul>
        </>
      ),
    },

    {
      ...
      content: (
        <>
          ...
          <p>
            Roof repairs address specific problem areas without replacing the
            entire system.
          </p>
          <ul>
            <li>Fixing damaged or missing shingles</li>
            <li>Sealing flashing areas</li>
            <li>Repairing gutters and fascia</li>
            <li>Patching flat roofs</li>
            <li>Fixing ice dam damage</li>
          </ul>
          ...
          <h4 className="text-secondary text-md md:text-lg font-semibold mt-6 mb-3">
            Popular Roofing Materials in Essex County, NJ
          </h4>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border text-left border-gray-300">
              ...
              <tbody>
                <tr>
                  <td className="border p-2 border-gray-500">Asphalt</td>
                  <td className="border p-2 border-gray-500">20–30 yrs</td>
                  <td className="border p-2 border-gray-500">Homes</td>
                  <td className="border p-2 border-gray-500">$3.5–$5.5</td>
                </tr>
                <tr>
                  <td className="border p-2 border-gray-500">Architectural</td>
                  <td className="border p-2 border-gray-500">30–50 yrs</td>
                  <td className="border p-2 border-gray-500">Premium homes</td>
                  <td className="border p-2 border-gray-500">$4.5–$7</td>
                </tr>
                <tr>
                  <td className="border p-2 border-gray-500">Metal</td>
                  <td className="border p-2 border-gray-500">40–70 yrs</td>
                  <td className="border p-2 border-gray-500">Durability</td>
                  <td className="border p-2 border-gray-500">$8–$14</td>
                </tr>
                <tr>
                  <td className="border p-2 border-gray-500">Flat/TPO</td>
                  <td className="border p-2 border-gray-500">15–25 yrs</td>
                  <td className="border p-2 border-gray-500">Flat roofs</td>
                  <td className="border p-2 border-gray-500">$5–$9</td>
                </tr>
                <tr>
                  <td className="border p-2 border-gray-500">Cedar</td>
                  <td className="border p-2 border-gray-500">20–40 yrs</td>
                  <td className="border p-2 border-gray-500">Luxury homes</td>
                  <td className="border p-2 border-gray-500">$9–$13</td>
                </tr>
              </tbody>
            </table>
          </div>
    ...
    {
      subtitle: "5. Areas Served: Essex County, NJ Roofing Contractor",
      content: (
        <>
          <p>
          ...
          <div className="overflow-x-auto mt-4">
            <table className="min-w-full border border-gray-300 text-left">
              <thead>
                <tr>
                  <th className="border border-gray-500 p-2">City / Town</th>
                  <th className="border border-gray-500 p-2">ZIP Code</th>
                </tr>
              </thead>
              <tbody>
          ...
          <ul>
            ...
            <li>
              <strong>Phone:</strong> English: 973-820-5130 | Espanol:
              973-342-4134
            </li>
            <li>
              <strong>Website:</strong> www.gutamaroofingnj.com
            </li>
          </ul>
        </>
      ),
